#!/bin/bash
rm -rf php-5.6.18
tar zxvf ./php/php-5.6.18.tar.gz
cd php-5.6.18
...
make install
cd ..
cp ./php-5.6.18/php.ini-production /alidata/server/php/etc/php.ini
#adjust php.ini
...
#self start
install -v -m755 ./php-5.6.18/sapi/fpm/init.d.php-fpm  /etc/init.d/php-fpm
